...
var Copayer = require('../../lib/model/zeler');


describe('Copayer', function() {

  describe('#fromObj', function() {
    it('read a zeler', function() {
      var c = Copayer.fromObj(testWallet.zelers[0]);
      c.name.should.equal('zeler 1');
    });
  });
  describe('#createAddress', function() {
    it('should create an address', function() {
      var w = Wallet.fromObj(testWallet);
      var c = Copayer.fromObj(testWallet.zelers[2]);
