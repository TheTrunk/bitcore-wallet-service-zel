...
Copayer.create = function(opts) {
  opts = opts || {};
  $.checkArgument(opts.xPubKey, 'Missing zeler extended public key')
    .checkArgument(opts.requestPubKey, 'Missing zeler request public key')
    .checkArgument(opts.signature, 'Missing zeler request public key signature');

  $.checkArgument(Utils.checkValueInCollection(opts.coin, Constants.COINS));

  opts.zelerIndex = opts.zelerIndex || 0;
