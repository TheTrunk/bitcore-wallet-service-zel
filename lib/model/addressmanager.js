...
AddressManager.create = function(opts) {
  ...
  x.zelerIndex = _.isNumber(opts.zelerIndex) ? opts.zelerIndex : Constants.BIP45_SHARED_INDEX;
...
AddressManager.prototype.getCurrentAddressPath = function(isChange) {
  return 'm/' +
    (this.derivationStrategy == Constants.DERIVATION_STRATEGIES.BIP45 ? this.zelerIndex + '/' : '') +
    (isChange ? 1 : 0) + '/' +
